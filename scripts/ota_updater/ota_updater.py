...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='ota firmware update scirpt for ESP8226 implemenation of the SmartIot mqtt IoT convention.')
    ...
    parser.add_argument('-t', '--base-topic',      type=base_topic_arg, required=False,
                        help='base topic of the SmartIoT devices on the broker', default="SmartIoT/")
    parser.add_argument('-i', '--device-id',       type=str,            required=True,
                        help='SmartIoT device id')
